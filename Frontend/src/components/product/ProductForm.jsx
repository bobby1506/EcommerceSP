...
const ProductForm = ({ addProduct, smessage, sproductCreated, sflag, emptymsg }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.price || formData.price <= 0) validationErrors.price = 'Price must be greater than zero';
    if (!formData.stocks || formData.stocks < 0) validationErrors.stocks = 'Stocks must be 0 or more';
    ...
    <>
      <div className="container mt-5">
        ...
        <form onSubmit={handleOnSubmit}>
          ...
          {/* Stocks/Inventory */}
          <div className="mb-3">
            <label htmlFor="stocks" className="form-label">Stocks/Inventory</label>
            <input
              type="text"
              className="form-control"
              id="stocks"
